...
<body style="background-color: #FCFBED">
	...
	<section class=" position-relative pt-lg-3 pt-xl-4 pt-xxl-5" style="color: #fef7d8;">
		...
		<div class="bg-warning rounded-circle position-absolute start-50 d-none d-lg-block "
			...
			data-aos="zoom-in" data-aos-duration="700" data-aos-delay="200" data-aos-offset="300"></div>
		<div class="container position-relative zindex-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
			<div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
				...
				<div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
					<!-- Left app sceen-->
					<p class=" mx-4 " style="font-size: 23px; color: #568A75;">
						<b>플래너,</b><br><b>건강한 반려식물을 키우는 습관</b>
					</p>
					...
					<div class="mx-auto mx-md-0" style="max-width: 500px;">
						...
						<div class="input-group rounded-pill">
							<div class="input-group-prepend">
								<button id="dropdownMenuButton" class="btn btn-secondary dropdown-toggle rounded-pill"
									type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">식물 유형</button>
								<div class="dropdown-menu">
									<a class="dropdown-item" onclick="selectSearchType('${path}/PlantSearch')">실내 식물</a> 
									<a class="dropdown-item" onclick="selectSearchType('${path}/FlowerSearch')">꽃</a> 
									<a class="dropdown-item" onclick="selectSearchType('${path}/DryGardenSearch')">다육이</a>
								</div>
							</div>
							<span class="input-group-text"> <i class="ai-search"></i> </span> 
							<input id="searchInput" type="search" class="form-control" placeholder="검색" onkeydown="handleSearchKeyPress(event)">
							<div class="input-group-append">
								<button id="searchButton" type="button" class="btn btn-primary rounded-pill" onclick="submitSearchForm()">검색</button>
							</div>
						</div>
					...
					<!-- Left features list-->
					<div class="mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right"
						data-aos-offset="300" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
						<div class="d-table bg-faded-dark rounded-1 p-2 mb-3 mb-lg-4">
							<a class="nav-link  text-warning" style="font-size: 30px;" href="${path}/PlantSearch"> <i class="ai-search fa-5x"></i></a>
						</div>
						<a href="${path}/PlantSearch">
							<h2 class="h4 text-white mb-2 mb-lg-3">검색 서비스</h2>
						</a>
						<p class="text-white opacity-80 mb-0">
							식물 검색 서비스는 사용자들에게 식물에 관한 정보를 검색하고 제공하는 서비스입니다. 이 서비스는 다양한 식물에 대한 정보를 찾고자 하는 사람들에게 도움을 줍니다.
						</p>
					</div>
					<div class="mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right"
						data-aos-delay="200" data-aos-offset="250" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
						<div class="d-table bg-faded-dark rounded-1 p-2 mb-3 mb-lg-4">
							<a class="nav-link  text-warning" style="font-size: 30px;" href="${path}/Myplant"> <i class="ai-calendar-check fa-5x"></i></a>
						</div>
						<a href="${path}/Myplant">
				...
				<div class="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
					...
					<div class="mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-left"
						data-aos-offset="200" data-aos-delay="600" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
						<div class="d-table bg-faded-dark rounded-1 p-2 mb-3 mb-lg-4">
							<a class="nav-link  text-warning" style="font-size: 30px;" href="${path}/ItemShop"> <i class="ai-droplet fa-5x"></i></a>
						</div>
						<a href="${path}/ItemShop"><h2 class="h4 text-white mb-2 mb-lg-3">원예도구 구매</h2></a>
		...
		<div class="row align-items-lg-center">
			...
			<div class="col-md-7 col-lg-7 pb-2 pb-lg-0 mb-4 mb-md-0">
				...
				<c:forEach var="todayFlower" items="${todayFlower}">
					<a href="${path}/FlowerDetail?id=${todayFlower.dataNo}" target="_blank"> <img class="rounded-5" src="${todayFlower.imgUrl1}" alt="Image">
					</a>
					<div class="accordion accordion-alt" id="industries">
						<div class="accordion-item mb-n3 mb-lg-n2 mb-xl-1 mt-sm-3">
							<h2 class="accordion-header" style="color: rgb(0, 0, 0);">
								<button class="accordion-button" type="button" data-bs-toggle="collapse" data-binded-content="#finance-img"
									data-bs-target="#finance" aria-expanded="true" aria-controls="finance">${todayFlower.flowNm}</button>
							</h2>
			...
			<div class="col-md-4 col-lg-4 col-xl-4 offset-1 d-none d-sm-none d-md-block"
				...
				<div class="ps-lg-4 ps-xl-0">
					...
					<c:forEach var="random" items="${randomList}">
						<div class="position-relative d-flex align-items-center mb-4">
							<img class="rounded" src="${random.firstimage}" href="${path}/arboretumDetail?id=${random.contentid}"
								...
								style="max-width: 110px; max-height: 110px; min-width: 110px; min-height: 110px;" alt="Post image">
							<div class="ps-3">
								<h4 class="h5 mb-2">
									<a class="stretched-link" href="${path}/arboretumDetail?id=${random.contentid}">${random.title}</a>
								</h4>
      ...
      ">
							...
							<div class="card border-0 h-100">
								<div class="card-body pb-4">
									<div class="d-flex align-items-center mb-4 mt-n1">
										<span class="fs-sm text-muted"><fmt:formatDate type="both" dateStyle="full" value="${proud.createDate}" /></span>
								...
								<div class="card-footer pt-3">
									...
									<h6 class="ps-3 mb-0">${proud.name}</h6>
									</a>
								</div>
							</div>
						</article>
			...
			<div class="container position-relative zindex-5 py-sm-4 py-lg-5 ">
				...
				<div class="d-flex align-items-center justify-content-between mb-3">
					<div class="fw-medium text-black text-uppercase"><h3 class="h1 text-center pt-2 pt-sm-3 pb-3 mb-3 mb-lg-4">나만 몰랐던 식집사의 필수템</h3></div>
					<!-- Slider prev/next buttons-->
					<div class="d-flex">
						<button class="btn btn-prev btn-icon btn-sm btn-outline-primary rounded-circle me-2" type="button" id="popular-prev">
							<i class="ai-arrow-left"></i>
						</button>
						<button class="btn btn-next btn-icon btn-sm btn-outline-primary rounded-circle ms-2" type="button" id="popular-next">
