...
<section class="container pt-5 pb-sm-3 mt-5 mb-2 mb-md-3 mb-lg-4 mb-xxl-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">휴양림</li>
		</ol>
	</nav>
	<!-- Page title-->
	...
	<c:forEach var="flList" items="${forestLodgeList}">
		<div class="row align-items-center pt-xl-2 pb-5 mb-lg-2 mb-xl-3 mb-xxl-4">
			<div class="col-md-6 col-lg-6 mb-4 mb-md-0">
				<a class="d-block position-relative image-container" href="${path}/arboretumDetail?id=${flList.contentid}">
					...
					<img class="d-block position-relative zindex-2 mx-auto rounded-5 fit-cover" src="${flList.firstimage}"
				...
				<div class="ps-md-3 ps-lg-0">
					<div class="d-flex align-items-center">
						...
						<button type="button" class="btn btn-outline-info btn-icon rounded-pill btn-sm ms-auto mb-4" 
							onclick="location.href='${path}/scrapplace?num=${flList.contentid}'"><i class="ai ai-bookmark"></i>
						</button>
					</div>
