...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
      ...
      <div class="container py-5 mt-5 mb-lg-4 mb-xl-5">
        ...
        <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4" style="max-width: 1100px; height: 200px;">
          <div class="card-body" style="padding-left: 10px;"> <!-- I added the inline style to adjust the padding on the left side -->
          ...
          <style>
            .text-large {
              font-size: 28px; /* 원하는 크기로 조정하세요 */
            }
          
            .text-bold {
              font-weight: bold; /* 두께를 bold로 조정합니다 */
            }
            .text-large2 {
              font-size: 20px;
              color: rgb(80, 121, 80);
        ...
        <div class="row pt-xl-3 mt-n1 mt-sm-0">
          <div class="col-lg-9 offset-lg-3 pt-lg-3">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <button class="btn btn-primary">등록하기</button> <!-- This is the registration button -->
            </div>
          </div>
        </div>
