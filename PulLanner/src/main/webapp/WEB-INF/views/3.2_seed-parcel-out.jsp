...
<section class="container py-5 mt-5 mb-sm-2 mb-lg-3 mb-xl-4 mb-xxl-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="pt-lg-3 pb-2 pb-md-4 breadcrumb">
			...
			<li class="breadcrumb-item"><a href="shop-catalog.html">Shop
					catalog</a></li>
  ...
  "navigation": {
    ...
    "nextEl": ".btn-next"
				...
				<div class="swiper-wrapper"
					style="max-width: 100%; max-height: 530px;">

					<!-- Item -->
					<div class="swiper-slide bg-light">
						<div
							class="swiper swiper-nav-onhover d-flex justify-content-center"
							style="max-width: 100%; min-height: 530px;"
							data-swiper-options="{&quot;loop&quot;: true, &quot;navigation&quot;: {&quot;prevEl&quot;: &quot;.btn-prev&quot;, &quot;nextEl&quot;: &quot;.btn-next&quot;}}">
							<div class="swiper-slide rounded-2">
								<div class="rounded-2"
									style="background-image: url( 'https://health.chosun.com/site/data/img_dir/2021/01/15/2021011502271_0.jpg' ); background-size: cover; background-repeat: no-repeat; background-position: center; width: 100%; min-height: 530px;"
									alt="Product"></div>
							</div>
						</div>
					</div>
					...
					<div class="swiper-slide bg-light">
						<div
							...
							<div class="swiper-slide rounded-2">
								<div class="rounded-2"
									style="background-image: url( 'https://blog.kakaocdn.net/dn/c93wPN/btrao7BzrpV/lkkqYbvkcIGQ0LvLwUEk31/img.jpg' ); background-size: cover; background-repeat: no-repeat; background-position: center; width: 100%; min-height: 530px;"
									alt="Product"></div>
							</div>
						</div>
					</div>
					...
					<button type="button"
						class="btn btn-prev btn-icon btn-outline-primary rounded-circle me-2">
						<i class="ai-arrow-left"></i>
					</button>
					<button type="button"
						class="btn btn-next btn-icon btn-outline-primary rounded-circle ms-2">
		...
		<div class="col-md-6 col-xl-5 offset-xl-1">
			...
			<div class="position-md-sticky top-0 ps-md-4 ps-lg-5 ps-xl-0">
				...
				<h1 class="d-none d-md-inline-block pb-1 mb-2">열무 씨앗</h1>
				<p class="fs-sm mb-4">잎이 다소 검은편으로 여름재배에 적합한 품종입니다. 초자는 입성으로 성장하여
					수확이 용이하고, 내서성이 강합니다.</p>
							...
							<div class="accordion-body py-1 mb-1">
								<div class="form-check">
									...
									<label class="form-check-label d-flex align-items-center"
										for="difficulty-all"><span class="text-nav fw-medium">재배
											시 유의사항 1 : 조기 파종을 하거나 수확기를 너무 늦추면 추대 및 상품성이 떨어질 위험이 있음</span> <!-- <span class="fs-xs text-muted ms-auto">697</span> -->
									</label>
								</div>
								<br>
								<div class="form-check">
									...
									<label class="form-check-label d-flex align-items-center"
										for="beginner"><span class="text-nav fw-medium">재배
											시 유의사항 2 : 질소 과다시 엽신장이 너무 빨라 엽맥이 다소 물러질 수 있음</span> <!-- <span class="fs-xs text-muted ms-auto">234</span> -->
									</label>
								</div>
      ...
      &quot;breakpoints&quot;: {
		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div
					class="card-hover position-relative bg-secondary rounded-1  mb-4">
					<button
					...
					<a class="d-block " href="shop-single.html"> <img
						class="d-block mx-auto object-fit: cover;"
						src="https://blog.kakaocdn.net/dn/c93wPN/btrao7BzrpV/lkkqYbvkcIGQ0LvLwUEk31/img.jpg"
						style="max-width: 280px; max-height: 280px; min-width: 280px; min-height: 280px;"
						alt="Product">
					</a>
				</div>
				<div class="d-flex mb-1">
					<h3 class="h6 mb-0">
						<a href="shop-single.html">개운죽</a>
					</h3>
			...
			<div class="swiper-slide">
				<div
					...
					<a class="d-block " href="shop-single.html"> <img
						class="d-block mx-auto object-fit: cover;"
						src="https://cdn.edujin.co.kr/news/photo/202004/32873_59244_305.jpg"
						style="max-width: 280px; max-height: 280px; min-width: 280px; min-height: 280px;"
						alt="Product">
					</a>
				</div>
      ...
      &quot;breakpoints&quot;: {
		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide text-center text-sm-start">
				...
				<p class="fs-sm mb-0">Free delivery for all orders over $200
					honcus egestas lorem honcus egestas</p>
			</div>
			<!-- Item-->
			<div class="swiper-slide text-center text-sm-start">
				<div class="text-primary mb-3 mb-sm-4">
				...
				<p class="fs-sm mb-0">We return money within 30 days honcus
					egestas lorem honcus egestas</p>
			</div>
			<!-- Item-->
			<div class="swiper-slide text-center text-sm-start">
				<div class="text-primary mb-3 mb-sm-4">
				...
				<p class="fs-sm mb-0">Friendly 24/7 customer support honcus
					egestas lorem honcus egestas</p>
			</div>
			<!-- Item-->
			<div class="swiper-slide text-center text-sm-start">
				...
				<p class="fs-sm mb-0">We possess SSL / Secure сertificate honcus
					egestas lorem honcus egestas</p>
			</div>
		</div>
		<!-- Pagination (Bullets)-->
