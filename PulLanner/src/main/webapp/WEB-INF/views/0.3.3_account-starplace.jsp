						...
						<div class="col-md-3">
							<div class="card">
								<div class="image-container">
										<img src="${scitem.FIRSTIMAGE}" class="card-img-top fit-cover" alt="image">
								</div>
								<div class="card-body">
									<h5 class="card-title text-truncate">${scitem.TITLE}</h5>
									<div class="d-flex justify-content-between">
											<a href="/arboretumDetail?id=${scitem.NUM}" type="button" class="btn btn-primary btn-sm rounded-pill">자세히보기</a>
									</div>
								</div>
							</div>
						</div>
