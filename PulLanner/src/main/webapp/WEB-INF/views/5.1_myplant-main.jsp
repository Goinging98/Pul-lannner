	...
	<section class="card border-3 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4"
		...
		<div class="card-body">
			<div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
				...
				<a class="btn btn-sm btn-secondary ms-auto" href="${path}/Plantwrite">
					<i class="ai-edit ms-n1 me-2"></i>식물등록</a>
			</div>
			...
			<div class="row gy-3 align-items-center pt-3 pt-sm-4 mt-md-2">
				<div class="col col-md-4 col-6 order-md-1 order-1">
					<div class="d-flex align-items-center">
						...
						<select class="form-select form-select-flush w-auto"></select>
					</div>
				</div>
