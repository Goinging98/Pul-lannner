...
<section class="container pt-5 pb-sm-3 mt-5 mb-2 mb-md-3 mb-lg-4 mb-xxl-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">국립공원</li>
		</ol>
	</nav>
	<!-- Page title-->
	<div class="d-flex align-items-center justify-content-end mb-4 pb-3">
		...
		<div class="col-md-5 mb-5 mt-3">
			<form name="searchForm" action="${path}/parkList" method="get">
	...
	<c:forEach var="pList" items="${parkList}">
		<div class="row align-items-center pt-xl-2 pb-5 mb-lg-2 mb-xl-3 mb-xxl-4">
			<div class="col-md-6 col-lg-6 mb-4 mb-md-0">
				<a class="d-block position-relative image-container" href="${path}/arboretumDetail?id=${pList.contentid}">
					<img class="d-block position-relative zindex-2 mx-auto rounded-5 fit-cover" src="${pList.firstimage}" width="636" alt="Image"
					data-aos="fade-in" data-aos-duration="400" data-aos-offset="250">
				</a>
			</div>
...
<script type="text/javascript">
	...
	function submitSearchForm() {
	    ...
	    form.action = "${path}/parkList?searchValue=" + searchValue + "&page=1";
	    form.submit();
	}
</script>
