	...
	<div class="row pt-sm-2 pt-lg-0">
		...
		<div class="col-lg-9 pt-4 pb-2 pb-sm-4">
			<div class="d-flex align-items-center mb-4">
				<h1 class="h2 mb-0">
					찜한 상품 <span class='fs-base fw-normal text-muted'>(6 items)</span>
				</h1>
				...
				<button class="btn btn-sm btn-outline-danger ms-auto" type="button">
					<i class="ai-trash ms-n1 me-2"></i>Clear all
				</button>
			</div>
					...
					<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
							...
							<div
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/02.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
										...
										type="button">
										<i class="ai-chevron-left fs-xl d-dark-mode-none"></i><i
									...
									<button
										...
										type="button">
										<i class="ai-chevron-right fs-xl d-dark-mode-none"></i><i
						...
						<div class="col pb-2 pb-sm-3">
							<div
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/01.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
							...
							<div class="d-flex mb-1">
								...
								<div class="d-flex ps-2 mt-n1 ms-auto">
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color1"
											value="Dark gray" checked id="color1-1"> <label
									...
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color1"
											value="Light gray" id="color1-2"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
						...
						<div class="col pb-2 pb-sm-3">
							<div
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/03.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
							...
							<div class="d-flex mb-1">
								...
								<div class="d-flex ps-2 mt-n1 ms-auto">
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color2"
											value="Light gray" checked id="color2-1"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
									...
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color2"
											value="Dark gray" id="color2-2"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
						...
						<div class="col pb-2 pb-sm-3">
							<div
								class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
								<span
									class="badge bg-gray text-nav position-absolute top-0 start-0 mt-3 ms-3">Out
									of stock</span>
								<button
									class="btn btn-icon btn-sm btn-light bg-light border-0 rounded-circle position-absolute top-0 end-0 mt-3 me-3 zindex-5 opacity-0"
									type="button">
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/06.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
						...
						<div class="col pb-2 pb-sm-3">
							<div
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/04.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
							...
							<div class="d-flex mb-1">
								...
								<div class="d-flex ps-2 mt-n1 ms-auto">
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color3"
											value="Gray concrete" checked id="color3-1"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
											for="color3-1"><span
											class="d-block bg-size-cover bg-position-center rounded-circle"
											style="width: .625rem; height: .625rem; background-color: #c0c0c0; background-image: url(/resources/assets/img/shop/pattern/marble.jpg);"></span></label>
									</div>
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color3"
											value="Beige" id="color3-2"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
						...
						<div class="col pb-2 pb-sm-3">
							<div
								...
								<div class="swiper swiper-nav-onhover"
									...
									<a class="swiper-wrapper" href="shop-single.html">
										<div class="swiper-slide p-2 p-xl-4">
											<img class="d-block mx-auto"
												src="/resources/assets/img/shop/products/05.png" width="226"
												alt="Product">
										</div>
									</a>
									<button
							...
							<div class="d-flex mb-1">
								...
								<div class="d-flex ps-2 mt-n1 ms-auto">
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color4"
											value="Gray" checked id="color4-1"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
									...
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color4"
											value="Woody brown" id="color4-2"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
											for="color4-2"><span
											class="d-block bg-size-cover bg-position-center rounded-circle"
											style="width: .625rem; height: .625rem; background-color: #c0c0c0; background-image: url(/resources/assets/img/shop/pattern/wood.jpg);"></span></label>
									</div>
									<div class="ms-1">
										<input class="btn-check" type="radio" name="color4"
											value="Gray marble" id="color4-3"> <label
											class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
											for="color4-3"><span
											class="d-block bg-size-cover bg-position-center rounded-circle"
											style="width: .625rem; height: .625rem; background-color: #c0c0c0; background-image: url(/resources/assets/img/shop/pattern/marble.jpg);"></span></label>
