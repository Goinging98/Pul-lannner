...
<div class="container py-5 mt-5 mb-2 mb-sm-3 mb-lg-4 mb-xxl-5">
	...
	<div class="swiper swiper-nav-onhover rounded-5"
		...
		<!-- Prev button -->
		<button type="button"
			class="btn btn-prev btn-icon btn-sm btn-outline-primary rounded-circle position-absolute start-0 top-50 translate-middle-y">
			<i class="ai-arrow-left"></i>
		</button>

		<!-- Next button -->
		<button type="button"
			class="btn btn-next btn-icon btn-sm btn-outline-primary rounded-circle position-absolute end-0 top-50 translate-middle-y">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b6706ca239a6ee45e14086e5313d42a3"></script>
