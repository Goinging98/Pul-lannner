			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<a class="d-block position-relative image-container2" href="#">
						...
						src="assets\img\landing\yoga-studio\trainers\sample.jpeg"
						width="636" alt="Image">
					</a>
				...
				<div class="swiper-slide">
					<a class="d-block position-relative image-container2" href="#">
						...
						<img
						class="d-block position-relative zindex-2 mx-auto fit-cover2 rounded-5"
						src="assets\img\landing\yoga-studio\trainers\sample2.jpeg"
						width="636" alt="Image">
					</a>
					<div class="pt-1 mt-sm-3">
						<div class="row pt-1 pt-lg-1 mt-1" style="margin-left: 8px;">
				...
				<div class="swiper-slide">
					<a class="d-block position-relative image-container2" href="#">
						...
						<img
						class="d-block position-relative zindex-2 mx-auto fit-cover2 rounded-5"
						src="assets\img\landing\yoga-studio\trainers\sample3.jpeg"
						width="636" alt="Image">
					</a>
					<div class="pt-1 mt-sm-3">
						<div class="row pt-1 pt-lg-1 mt-1" style="margin-left: 8px;">
